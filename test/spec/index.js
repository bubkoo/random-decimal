...
describe('random-natural', function () {
  ...
  var randomDecimal = require('../../index');
  ...
  it('randomDecimal(2, 10, "foo")', function () {
    expect(randomDecimal(2, 10, "foo")).to.be.a('number');
  ...
  it('randomDecimal(10, 2)', function () {
    expect(randomDecimal(10, 2)).to.be.a('number');
  ...
  it('randomDecimal("abc", {a: 1})', function () {
    expect(randomDecimal("abc", {a: 1})).to.be.a('number');
